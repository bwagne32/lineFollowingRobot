...
unsigned long previousTime = 0; // microseconds
uint16_t timeDiff = 500; // microseconds
...
void loop() { 
  PID_HPP_::position = qtr.readLineBlack(PID_HPP_::sensorValues);
